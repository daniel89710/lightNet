...
void calibrate_network(network *net, int id);
int get_num_sparsity(layer l);
void prune_weights(network *net);
void debug_weights(network *net);
void sparsify_weights(network *net);  
