...
void spatial_softmax_x_ent_gpu(int n, int c, int stride, float *pred, float *truth, float *delta, float *error, float *biases);
void logistic_x_ent_gpu(int n, float *pred, float *truth, float *delta, float *error);  

void apply_fake_quantization_gpu(int n, float *data, float scale, int max_value);
